...
import { signInWithCredentials, signInWithGoogle, signInWithLinkedIn } from "@/app/[locale]/(public)/auth/sign-in/actions";
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-sm text-gray-500">
        ...
        <a href={`/${locale}/auth/sign-up`} className="text-[var(--color-gold)] font-medium hover:underline">
          Create account
        </a>
      </p>
    </div>
